...
> **Let op!** `format` is optioneel afdwingbaar afhankelijk van de validator. Sommige validators controleren format niet standaard, of alleen als dit expliciet is ingesteld. Voor strikte validatie die overal werkt, kun je beter gebruikmaken van de pattern property (reguliere expressies) in plaats van format.
